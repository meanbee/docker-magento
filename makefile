...
*/*/run-cron.sh: lib/run-cron-sh/main.m4 $(TEMPLATE_LIB)
	m4 -I ./lib lib/run-cron-sh/main.m4 > $@
	chmod u+x $@

5.5/cli/Dockerfile: 5.5/cli/Dockerfile.m4 5.5/cli/php.ini 5.5/cli/entrypoint.sh 5.5/cli/run-cron.sh $(TEMPLATE_LIB)
	m4 -I ./lib $@.m4 > $@
...
5.6/cli/Dockerfile: 5.6/cli/Dockerfile.m4 5.6/cli/php.ini 5.6/cli/entrypoint.sh 5.6/cli/run-cron.sh $(TEMPLATE_LIB)
	m4 -I ./lib $@.m4 > $@
...
7.0/cli/Dockerfile: 7.0/cli/Dockerfile.m4 7.0/cli/php.ini 7.0/cli/entrypoint.sh 7.0/cli/run-cron.sh $(TEMPLATE_LIB)
	m4 -I ./lib $@.m4 > $@
